...
app.post('/gerar-pdf', (req, res) => {
  ...
  doc.fontSize(14).font('Helvetica').text('oportunidade que foi autuado pelo suposto cometimento da infração prevista no Art. 175 do Código de Trânsito Brasileiro.', { align: 'left' });
  doc.moveDown();
...
doc.moveDown();
  ...
  doc.fontSize(14).font('Helvetica').text('A titulo de exemplo verifica-se que o art. 175 do CTB, com base na observância do MBFT, prevê no campo “Quando Autuar” a possibilidade de imputação de penalidade em várias possibilidades, ou seja, condutar distintas.', { align: 'left' });
  doc.moveDown();
...
*/
//-------------------------------------------------------------------------------------------
  const pdfFilename = 'Petição Modelo Art 175.pdf';
